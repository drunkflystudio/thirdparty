...
if not exist "%~dp0Build\Protobuf.MinGW\_temp" mkdir "%~dp0Build\Protobuf.MinGW\_temp"
cd /D "%~dp0Build\Protobuf.MinGW\_temp" || exit /B 1

cmake -G "MinGW Makefiles" ^
    -DCMAKE_BUILD_TYPE=Release ^
    -DCMAKE_INSTALL_PREFIX:PATH="%~dp0Build\Protobuf.MinGW" ^
