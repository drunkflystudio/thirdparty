...
macro(translate_list_input name cmake_var type)
    if(DEFINED INPUT_${name})
        list(JOIN INPUT_${name} "[[;]]" value)
        list(APPEND cmake_args "-D${cmake_var}${type}=${value}")
        drop_input(${name})
    endif()
endmacro()
...
translate_list_input(includes QT_EXTRA_INCLUDEPATHS ":PATH")
translate_list_input(lpaths QT_EXTRA_LIBDIRS ":PATH")
