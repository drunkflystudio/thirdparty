...
function(_qt_internal_protoc_generate target generator output_directory)
    ...
    _qt_internal_assign_to_internal_targets_folder(${deps_target})
...
function(qt6_add_protobuf target)
    ...
    source_group("Generated Files" FILES ${cpp_sources} ${qml_sources})
    ...
    if(is_static OR (WIN32 AND NOT is_executable))
        if(TARGET ${target}_protobuf_registration)
            source_group("Generated Files" FILES ${type_registrations})
            ...
            _qt_internal_assign_to_internal_targets_folder(${target}_protobuf_registration)
        ...
        if(export_macro_file)
            source_group("Generated Files" FILES ${export_macro_file})
